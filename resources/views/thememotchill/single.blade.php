        ...
        <div class="pt-2 grid grid-cols-12 gap-x-5">
            <section class="md:col-span-9 col-span-12">
                ...
                <div class="body-font overflow-hidden bg-[#181818] mt-2">
                    <div class="py-2">
                        <div class="mx-auto bg-zinc-900 rounded-md flex flex-wrap">
                                ...
                                <div class="md:w-full w-10/12 mx-auto">
                                    ...
                                    <div class="text-center mt-1">
                                        <a title="Xem Phim {{ $currentMovie->name }}" href="{{ $watchUrl }}"
                                            class="flex mx-auto justify-center px-6 py-3 mt-2 font-semibold rounded bg-[#408BEA] hover:opacity-90 text-white"><i><svg
                            ...
                            <div class="md:w-7/12 w-full md:pl-10">
                                <h1
                                    class="text-gray-300 text-center md:text-left text-xl font-bold mb-1 uppercase md:pt-0 pt-3">
                                    {{ $currentMovie->name }}
                                </h1>
                                <h2 class="text-md text-center md:text-left text-gray-400">
                                    {{ $currentMovie->origin_name }} ({{ $currentMovie->publish_year }})
                                </h2>
                                <div class="overflow-hidden shadow md:rounded-lg pt-2">
                                    <div class="bg-[#222222]">
                                        <dl>
                                            <div class="px-2 py-2 grid grid-cols-3 md:gap-2 md:px-3">
                                                ...
                                                <dd class="mt-1 text-sm text-gray-300 col-span-2 md:mt-0">
                                                    <span
                                                        class="font-medium mr-2 px-2 py-0.5 bg-blue-600 text-[14px]">{{ $currentMovie->episode_current }}
                                            ...
                                            <div class="px-2 py-2 grid grid-cols-3 md:gap-2 md:px-3">
                                                ...
                                                <dd class="mt-1 text-sm text-gray-300 col-span-2 md:mt-0">
                                                    {{ motchill_format_view($currentMovie->view_total) }}
                                                </dd>
                                            </div>
                                        </dl>
                                    </div>
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full">
                                <ul id="tabs"
                                    class="flex flex-wrap text-sm font-medium text-center text-white py-2 gap-x-2 border-t border-zinc-800 mt-2">
                                    <li class="bg-[#A3765D] rounded -mb-px mr-2 last:mr-0 text-center">
                                        <a class="cursor-pointer text-xs font-bold uppercase px-3 py-2 shadow-lg rounded block leading-normal"
                                            id="default-tab" href="#episode">Danh sách tập</a>
                                    </li>
                                    <li class="-mb-px mr-2 last:mr-0 text-center">
                                        <a class="cursor-pointer text-xs font-bold uppercase px-3 py-2 shadow-lg rounded block leading-normal "
                                            href="#description">Thông tin phim</a>
                                    </li>
                                    <li class="-mb-px mr-2 last:mr-0 text-center">
                                        <a class="cursor-pointer text-xs font-bold uppercase px-3 py-2 shadow-lg rounded block leading-normal "
                                            href="#actor">Diễn viên</a>
                                    </li>
                                ...
                                <div id="tab-contents"
                                    ...
                                    <div id="episode" class="p-4">
                                        <h3 class="text-sm font-medium text-center uppercase text-zinc-300 block"> Tập Phim
                                        </h3>
                                        <div class="pt-3 flex flex-row flex-wrap gap-x-2">
                                            @foreach ($currentMovie->episodes->sortBy([['server', 'asc']])->groupBy('server') as $server => $data)
                                                @foreach ($data->sortBy('name', SORT_NATURAL)->groupBy('name') as $name => $item)
                                                    <a style=" background: rgba(255, 255, 255, 0.2); padding: 10px; border-radius: 3px;"
                                    ...
                                    <div id="actor" class="hidden p-4">
                                        <span class="text-sm font-medium text-center uppercase text-zinc-300 block">Diễn
                                            Viên</span>
                                                ...
                                                ? $currentMovie->actors->map(function ($actor) {
                                                        return '<a class="hover:opacity-80 grid w-24 grid-cols-1 text-center" href="' .
                                                            ...
                                                            '">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <span class="text-sm font-medium text-gray-300 pt-2 truncate">' .
                                                            $actor->name .
                                                            '</span>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        </a>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ';
                                    ...
                                    @if ($currentMovie->trailer_url)
                                        <div id="trailer" class="hidden p-4">
                                            @php
                                                parse_str(
                        ...
                        @if ($currentMovie->showtimes && $currentMovie->showtimes != '')
                            <div class="text-base p-2 bg-black my-2 border border-blue-900">
                        ...
                        <div class="mt-3 pb-2 border-t border-gray-800 border-opacity-75">
                            ...
                            <span class="text-gray-200 text-sm">xem phim {{ $currentMovie->name }} thuyết minh full hd,
                                {{ $currentMovie->name }} trailer, review, {{ $currentMovie->origin_name }} vietsub,
                                motphim, phimmoi</span>
                        </div>
                    </div>
                </div>
                            ...
                            @foreach ($movie_related as $movie)
                                <div>
                                    <article
                                        ...
                                        <a class="relative" title="Phim {{ $movie->name }} {{ $movie->publish_year }}"
                                        ...
                                        <div class="mt-3 px-2">
                                            <a title="{{ $movie->name }}" href="{{ $movie->getUrl() }}">
                                                <span
                                                    class="text-[15px] font-medium capitalize pt-1 block truncate">
                                                    {{ $movie->name }}
                                                </span>
