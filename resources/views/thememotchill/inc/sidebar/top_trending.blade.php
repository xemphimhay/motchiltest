...
<div class="myui-panel clearfix right-content">
    <div class="pb-2">
        <div>
            <span class="uppercase text-gray-200 text-xl font-normal border-dashed border-b border-zinc-600 w-full block pb-2">{{ $top['label'] }}</span>
        </div>
    </div>
        ...
        <div class="most-view block">
            ...
            <ul class="list-film">
                @foreach ($top['data']['d'] as $key => $movie)
                    <li class="item d">
                        <span class="bg-zinc-600 number-rank absolute">{{ $loop->iteration }}</span>
