<div class="box-rating" itemprop="aggregateRating" itemscope itemtype="https://schema.org/AggregateRating">
    ...
    <div>
        <div id="div_average" style="line-height: 16px; margin: 0 5px; ">
            <span id="hint"></span>
            (<span class="average" id="average" itemprop="ratingValue">{{ number_format($currentMovie->rating_star ?? 8, 1) }}</span>
                điểm /
            <span id="rate_count" itemprop="ratingCount">{{ $currentMovie->rating_count + 1 }}</span> &nbsp;lượt)
        </div>
